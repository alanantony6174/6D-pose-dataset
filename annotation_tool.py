"""Manual annotation tool for datasets with 6D format
...
################################################################################
p = {
    # Folder containing the 6D datasets.
    "dataset_path": "6D_Dataset",
...
class AppWindow:
    ...
    def __init__(self, width, height, scenes):
        ...
        self.window = gui.Application.instance.create_window(
            "6D manual annotation tool", width, height
        )
    ...
    def _on_menu_about(self):
        ...
        # Add the text
        dlg_layout = gui.Vert(em, gui.Margins(em, em, em, em))
        dlg_layout.add_child(gui.Label("6D manual annotation tool"))
